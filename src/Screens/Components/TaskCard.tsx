    ...
    <TouchableOpacity style={[style.card,tw`${1}`]} activeOpacity={0.6}>
      <View style={style.row}>
        ...
        <Text style={style.task} numberOfLines={3} ellipsizeMode="tail">
          ...
          laudantium, magnam nemo ab recusandae sed ducimus culpa fuga fugit
          numquam quas voluptas, quam nisi praesentium nihil repellat accusamus id?
        </Text>
...
const style = {
  card: tw`bg-yellow-400 p-4 rounded-6 h-auto`,
